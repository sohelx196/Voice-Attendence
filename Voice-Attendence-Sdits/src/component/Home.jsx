    ...
    <>
      <div className="googleFont relative h-screen w-full flex flex-col md:flex-row justify-center items-center p-10 rounded-t-3xl">
        ...
        <div className="text-center md:text-left mt-8 md:mt-0 md:ml-10">
          <h1 className="googleFont text-6xl font-extrabold drop-shadow-md animate-fade-in">Welcome</h1>
          <h1 className="googleFont text-4xl font-semibold mt-2 animate-slide-up">Online Voice Attendance</h1>

          <button className="font-bold border-black mt-6 px-6 py-3 bg-white text-black text-lg  rounded-lg 
